...
export function generateStaticParams() {
    return ["beach", "computer", "fish", "fishing"].map(topic => ({ topic }));
}
...
export default async function Page({ params: { topic } }: PageProps) {
    ...
    return (
        <div>
            ...
            <Alert>
                This page <strong> generateStaticParams</strong> to render and cache static pages at build time, even though the URL has a dynamic parameter.
